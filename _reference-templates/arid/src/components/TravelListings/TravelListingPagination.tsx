          ...
          <div className="flex flex-wrap items-center space-x-1">
            ...
            {pageNumbers[0] > 1 && (
              <>
                <Link
                  href="#"
                  className="px-2 sm:px-3 py-2 sm:py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors leading-1"
                >
                  1
                </Link>
                {pageNumbers[0] > 2 && (
            ...
            {pageNumbers.map((page) => (
              <Link
                key={page}
                href="#"
                className={`px-2 py-2 sm:px-3 sm:py-2 rounded-lg text-sm font-medium transition-colors leading-1 ${
                  page === currentPage
...
export default TravelListingPagination;
